package com.match.system.controller;
...
import com.match.common.security.annotation.InnerAuth;
import com.match.common.security.annotation.RequiresPermissions;
import com.match.common.security.service.TokenService;
import com.match.common.security.utils.SecurityUtils;
import com.match.system.api.domain.SysDept;
...
import com.match.system.service.ISysPermissionService;
import com.match.system.service.ISysPostService;
import com.match.system.service.ISysRoleService;
...
public class SysUserController extends BaseController
{
    ...
    public R<SysUser> getUserInfoById(@PathVariable("userId") Long userId) {
        SysUser sysUser = userService.selectUserById(userId);
        if (StringUtils.isNull(sysUser)) {
            return R.fail("用户不存在");
        }
