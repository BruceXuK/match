...
import com.match.system.api.factory.RemoteUserFallbackFactory;
...
public interface RemoteUserService
{
    ...
    R<SysUser> getUserInfoById(@PathVariable("userId") Long userId, @RequestHeader(SecurityConstants.FROM_SOURCE) String source);
}
